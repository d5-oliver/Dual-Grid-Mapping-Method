...
switch testCase
    ...
    case 1
        ...
        par.g0 = @(t) par.v(par.x0)*ones(size(t));
        ...
        tSteps = round(par.K*[0.1,1,2,6,10,14,18]/(par.tK - par.t0));
    ...
    case 2
        ...
        par.g0 = @(t) par.v(par.x0)*heaviside(3-t);
        par.gL = @(t) zeros(size(t));
    ...
    case 5
        ...
        tSteps = round(par.K*([0.1,1,2,6,10,14,18]/10)/(par.tK - par.t0));
    ...
    case 6
        ...
        tSteps = round(par.K*[0.1,0.4,0.9,2,4,5,6]/(par.tK - par.t0));
